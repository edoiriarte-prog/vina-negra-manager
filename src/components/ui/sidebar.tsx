...
import { Sheet, SheetContent, SheetTitle } from "@/components/ui/sheet" // <-- Importamos SheetTitle
...
import { SidebarContext, SIDEBAR_COOKIE_NAME, SIDEBAR_COOKIE_MAX_AGE, SIDEBAR_WIDTH, SIDEBAR_WIDTH_MOBILE, SIDEBAR_WIDTH_ICON, SIDEBAR_KEYBOARD_SHORTCUT } from "@/hooks/use-sidebar"
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
             {/* ESTA LÍNEA ES LA QUE FALTABA PARA EL ERROR */}
...
// ... (Resto del archivo: SidebarTrigger, SidebarRail, SidebarInset, etc. se mantienen igual)
// Para mantener el archivo completo y funcional, aquí va el resto:
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-8 w-full bg-background shadow-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
        className
      )}
      {...props}
    />
