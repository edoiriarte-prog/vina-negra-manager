...
import { 
  MoreHorizontal, ArrowUpDown, Eye, Edit, Trash
} from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
...
import { SalesStatusStepper } from "./SalesStatusStepper"; // IMPORTAMOS EL NUEVO COMPONENTE

// --- COMPONENTE DE ACCIONES (SIN CAMBIOS) ---
...
export const getColumns = ({ onEdit, onDelete, onPreview, clients }: GetColumnsProps): ColumnDef<SalesOrder>[] => [
  ...
  },
  {
    accessorKey: "status",
    header: "Estado",
    cell: ({ row }) => <SalesStatusStepper order={row.original} />, // AQUI SE INTEGRA EL NUEVO COMPONENTE
  },
  {
