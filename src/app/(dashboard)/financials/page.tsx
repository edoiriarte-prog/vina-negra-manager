...
import { PlusCircle, ArrowUpCircle, ArrowDownCircle, FilterX, ChevronDown, ArrowRightCircle, Download, Trash2 } from 'lucide-react';
    ...
    <>
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
            <div>
              <h1 className="font-headline text-3xl">Tesorería</h1>
              <p className="text-muted-foreground">Registra movimientos bancarios y gestiona las cuentas.</p>
            </div>
                                    ...
                                    <Card key={acc.id} className="flex flex-col">
                                        ...
                                        <CardContent className="flex-1 flex flex-col justify-between">
                                            ...
                                            <div className="mt-4 text-sm space-y-1">
                                                <div 
                                                    className="flex justify-between items-center cursor-pointer hover:bg-muted p-1 rounded-md"
