  ...
  return (
    <div ref={ref} className="p-8 bg-white text-black font-sans">
      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="flex-grow space-y-6">
          {items.map((item, index) => (
            <div key={index} className="border-4 border-black p-5 m-2.5 page-break-inside-avoid">
      ...
      {/* Page 2: Individual Label Sample */}
       <div className="w-full flex-col items-center justify-center pt-10 hidden print:block">
